...
-(UIImage*)resizedImageToFitInSize:(CGSize)boundingSize scaleIfSmaller:(BOOL)scale
{
    ...
    if (self.images) {
        ...
        [frames enumerateObjectsUsingBlock:^(TOImageFrame * _Nonnull imageFrame, NSUInteger idx, BOOL * _Nonnull stop) {
            UIImage* resizedImage = [imageFrame.image resizedImageToSize:dstSize];
            TOImageFrame* resizedImageFrame = [TOImageFrame frameWithImage:resizedImage duration:imageFrame.duration];
            [resizedFrames addObject:resizedImageFrame];
        }];
        
        return [UIImage animatedImageFromFrames:resizedFrames];
    } else {
